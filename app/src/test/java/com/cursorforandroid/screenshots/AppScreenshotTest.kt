...
class AppScreenshotTest {
    ...
    fun projectView() {
        ...
        // The Project itself is the chat's panel. A coordinator's opens on its Project tab (the notes, as on
        // cursor.com); its Chat tab carries the Project section, open by default, right under the Overview — the
        // primaries with their status and menus, New primary and Adopt a chat (the demo stands in for the account, so
        // its actions are offered), and the shared context a tap away.
