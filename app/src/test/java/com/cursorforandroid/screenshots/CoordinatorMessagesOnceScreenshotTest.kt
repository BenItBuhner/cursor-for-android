...
class CoordinatorMessagesOnceScreenshotTest {
    ...
    fun coordinatorMessagesOnce() {
        ...
        // Every SendToAgent is a subagent row of its own; the stretches around them close each run with its footer.
        assertThat(rows.count { it is TranscriptRow.Subagent }).isEqualTo(11)
        assertThat(stretches.map { it.summary.text }).containsExactly(
            "1 note",
            "Worked 59s · 1 note",
            "1 note",
            "Worked 20s · 1 edit · 1 agent · 2 notes",
            "Worked 21s · 1 edit · 1 agent · 1 note",
            "Worked 22s · 1 edit · 1 agent · 1 note",
            "Worked 2m 7s · 1 note",
            "Worked 1m 1s · 1 edit · 1 note",
            "Working · 1 step",
        ).inOrder()
        show(rows)
