...
/**
 * The composer's dictation while voice input is on ([AppGraph.voiceInput]: the Experimental switch, in Extended mode,
 * outside the demo); null otherwise, which leaves the send slot as it always was. Shared by every real composer.
 */
@Composable
