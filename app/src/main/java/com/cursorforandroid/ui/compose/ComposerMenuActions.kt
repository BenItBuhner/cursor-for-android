 ...
 * (Extended mode, when [onPickFiles] is given), recent skill names from preferences, and the encrypted MCP server
 * list. Shared by the New Chat and conversation composers so both menus behave the same.
 */
@Composable
