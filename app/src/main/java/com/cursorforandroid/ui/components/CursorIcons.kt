...
object CursorIcons {
    ...
    /** Lucide `pause`: holding a Project's primary without ending its turn. */
    val Pause: ImageVector by lazy {
        icon("Pause") {
            rect(14f, 3f, 5f, 18f, 1f)
            rect(5f, 3f, 5f, 18f, 1f)
        }
    }
    ...
    /** A new chat written and not sent, in the sidebar: Lucide's pencil-line, the pencil over the line it is writing. */
    val Draft: ImageVector by lazy {
        icon("Draft") {
            path("M13 21h8")
            path("M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z")
            path("m15 5 4 4")
