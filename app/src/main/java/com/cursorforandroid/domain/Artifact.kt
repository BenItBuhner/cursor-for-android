...
data class Artifact(
    ...
    val kind: Kind
        get() = when (extension) {
            "png", "jpg", "jpeg", "gif", "webp", "bmp", "svg", "heic", "heif", "avif", "ico" -> Kind.Image
            "mp4", "webm", "mov", "mkv", "m4v", "3gp" -> Kind.Video
            "mp3", "m4a", "aac", "wav", "ogg", "oga", "opus", "flac" -> Kind.Audio
    ...
    enum class Kind { Image, Video, Audio, Markdown, Text, Other }
}
