...
- Sidebar (edge-swipe drawer on phones, permanent 280dp column on tablets and foldables): the "+" new-chat button, search, the filter menu (group by, sort, Repo / Status / Git / Source filters, metadata toggles) and the sidebar toggle in the header, "Chats" with Pinned and date groups, pull-to-refresh, long-press actions (pin, open on cursor.com, copy link, archive, delete).
